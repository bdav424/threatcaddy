...
import syncDeviceRoutes from './routes/sync-devices.js';
...
app.route('/api/passkeys', passkeyRouter);
app.route('/api/sync', syncRoutes);
app.route('/api/sync/devices', syncDeviceRoutes);
...
app.route('/api/push-tokens', pushTokenRoutes);
