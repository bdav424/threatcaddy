  ...
  <w:body>
    ...
    <w:sectPr><w:headerReference w:type="default" r:id="rIdHeader"/><w:footerReference w:type="default" r:id="rIdFooter"/><w:pgSz w:w="12240" w:h="15840"/></w:sectPr>
      ...
      },
      {
        ...
        content: '<w:hdr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:p><w:r><w:t>Confidential - Enterprise Restricted</w:t></w:r></w:p></w:hdr>',
      },
    ]);
    ...
    expect(headerXml).toContain('Confidential - Enterprise Restricted');
  });
