...
export function getStandardLists(): WordLists {
  return {
    ...
    nouns: [
      ...
      'PROTOCOL', 'ENIGMA', 'DOCX_TEMPLATE', 'BEACON', 'HORIZON', 'DIRECTIVE', 'MANDATE',
...
export function getUnhingedLists(): WordLists {
  return {
    adjectives: [
      ...
      'CHAInternalALLY-NEUTRAL', 'OMINOUSLY-CHEERFUL', 'QUESTIONABLY-LEGAL', 'MILDLY-CURSED', 'FERAL',
...
export function getDefconPartyLists(): WordLists {
  return {
    adjectives: [
      ...
      'PROFOUNDLY-UNSERIOUS', 'STRATEGICALLY-CHAInternal', 'WEAPONIZED-WHOLESOME',
