...
export function getStandardLists(): WordLists {
  return {
    ...
    nouns: [
      ...
      'PROTOCOL', 'ENIGMA', 'VENDOR', 'BEACON', 'HORIZON', 'DIRECTIVE', 'MANDATE',
...
export function getUnhingedLists(): WordLists {
  return {
    adjectives: [
      ...
      'CHAINTELALLY-NEUTRAL', 'OMINOUSLY-CHEERFUL', 'QUESTIONABLY-LEGAL', 'MILDLY-CURSED', 'FERAL',
...
export function getDefconPartyLists(): WordLists {
  return {
    adjectives: [
      ...
      'PROFOUNDLY-UNSERIOUS', 'STRATEGICALLY-CHAINTEL', 'WEAPONIZED-WHOLESOME',
