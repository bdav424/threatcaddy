...
Tag each hypothesis with "hypothesis" plus "hypothesis-status:<open|confirmed|refuted>" so the team sees what's open. Skip topics already covered — search_notes for "Hypothesis:" first. Don't enrich IOCs or build timelines; those are other specialists' jobs. Your output is the team's working theory of the case.`,
  ...
  },
  {
    ...
    allowedTools: ['list_iocs', 'read_ioc', 'create_ioc', 'update_ioc', 'fetch_url', 'enrich_ioc', 'create_note', 'search_notes', 'read_note', 'get_investigation_summary', 'search_all', 'link_entities', 'create_timeline_event', 'extract_iocs', 'list_integrations', ...EVIDENCE_READ_TOOLS, ...VIRUSTOTAL_AGENT_HOST_TOOLS],
  ...
  },
  {
    ...
    allowedTools: ['list_iocs', 'read_ioc', 'create_ioc', 'update_ioc', 'fetch_url', 'enrich_ioc', 'create_note', 'search_notes', 'read_note', 'get_investigation_summary', 'search_all', 'link_entities', 'create_timeline_event', 'list_timeline_events', 'list_integrations', ...EVIDENCE_READ_TOOLS, ...VIRUSTOTAL_AGENT_HOST_TOOLS],
