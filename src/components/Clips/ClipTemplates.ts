...
`,
  ...
  {
    name: 'External Backup User Details',
    icon: '🔑',
    category: 'Cloud',
    content: `# External Backup User Details

**User Resource ID:** resource-id-example
**account:**
**Email:** user@domain.com
**Created:**
**Last Login:**
...
`,
  ...
  {
    name: 'External Backup account Details',
    icon: '🏢',
    category: 'Cloud',
    content: `# External Backup account Details

**account Resource ID:** resource-id-example
**account Name:**
**Home Region:**
**Created:**
...
| Policy Name | workspace | Statements |
|-------------|-------------|------------|
|             |             |            |
