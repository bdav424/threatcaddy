  ...
  return (
    <Modal open onClose={onCancel} title={link ? t('quickLinks.editLink') : t('quickLinks.addLinkTitle')}>
      <div className="space-y-4">
        <div>
          <label htmlFor="quick-link-title" className={labelClass}>Title *</label>
          <input
            id="quick-link-title"
            value={title}
        ...
        <div>
          <label htmlFor="quick-link-url" className={labelClass}>URL *</label>
          <input
            id="quick-link-url"
            value={url}
        ...
        <div>
          <label htmlFor="quick-link-description" className={labelClass}>Description</label>
          <input
            id="quick-link-description"
            value={description}
        ...
        <div>
          <label htmlFor="quick-link-icon" className={labelClass}>Icon (emoji)</label>
          <input
            id="quick-link-icon"
            value={icon}
