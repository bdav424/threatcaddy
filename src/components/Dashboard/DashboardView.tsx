...
import { Plus, Pencil, Trash2, FileText, ListChecks, Clock, PenTool, Search, Network, Activity, MessageSquare, FileOutput, FlaskConical } from 'lucide-react';
...
const INTERNAL_TOOLS: { view: ViewMode; labelKey: string; descKey: string; icon: typeof FileText; color: string }[] = [
  ...
  { view: 'experimental', labelKey: 'view.experimental', descKey: 'view.experimentalDesc', icon: FlaskConical, color: '#fb7185' },
  ...
  return (
    <div className="flex-1 overflow-y-auto">
      ...
      <div className="p-6">
        ...
        {/* Internal Tools */}
        {onViewChange && (
          <section className="mt-8" aria-labelledby="dashboard-tools-heading">
            <h3 id="dashboard-tools-heading" className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">{t('view.threatcaddyTools')}</h3>
