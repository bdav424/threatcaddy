...
export function CaddyShackView({ folderId, folderName, settings }: CaddyShackViewProps) {
  ...
  const onboardingPanel = (
    <div className="absolute inset-0 z-[5] flex items-center justify-center bg-black/60 backdrop-blur-sm rounded-xl">
      <div className="bg-[var(--bg-primary)] border border-[var(--border)] rounded-xl shadow-2xl p-6 max-w-md mx-4 w-full">
        <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-4">Getting Started with Team Feed</h3>
